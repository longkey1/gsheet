...
var filesCmd = &cobra.Command{
	Use:   "files",
	Short: "Manage spreadsheet files",
}
...
func init() {
	...
	filesListCmd.Flags().StringP("query", "q", "", "Search spreadsheets by name")
	filesListCmd.Flags().Bool("mine", false, "Show only spreadsheets owned by me")
